...
const SignUp = () => {
    return (
        <div className='my-20  flex justify-center bg-[#3ffbd8] items-center rounded-3xl'>
            <div class="max-w-4xl mx-auto font-[sans-serif] p-6">
                <div class="text-center mb-16">

                    <h4 class="text-gray-800 text-base font-semibold mt-6">Sign up for your account</h4>
                </div>
